...
<%@ page import="ft.appointment.SetAppointmentAction"%>
...
<body>
	...
	<s:label value="Date: "/><s:property value="date" /><br>	
	<s:label value="Time: "/><s:property value="time" /><br><br>		
	<s:label value="Message: "/><s:property value="message" /><br>
